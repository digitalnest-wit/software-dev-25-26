...
while True:
    ...
    if choice == "1":
        ...
        if song_name == "":
            # song_name should not be empty. Display an error message
            # and continue
        ...
        # artist should not be empty. If artist is empty, display an
        # error message and continue
        if artist == "":
            print('Artist should not be empty')
            continue
        ...
        # If total_songs is 0, display a message letting the user know
        ...
        # Update the total_plays variable (increment by one)
        total_plays += 1
        ...
        # Display total_songs, total_plays, and favorite_song and
        ...
        # Display summary with total_songs and total_plays, then break
        print(f'Total songs: {total_songs}')
        print(f'Total plays: {total_plays}')
        break
